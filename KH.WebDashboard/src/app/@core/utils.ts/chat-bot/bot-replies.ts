// const botAvatar: string = 'assets/gif/bot.gif';
...
export const botReplies = [
  {
    ...
    answerArray: ['Hello!', 'Yes?', 'Yes, milord?', 'welcome to Khnight Chat chat bot how can I help you?'],
    type: 'text',
    reply: {
      text: ' Welcome to knight',
      reply: false,
      date: new Date(),
      user: {
        name: 'Khalifa Bot',
  ...
  },
  {
    ...
    answerArray: [`knight Chat  Bot وعليكم السلام اهلا بك في `],
    type: 'text',
    reply: {
      text: '',
      reply: false,
...

  {
    ...
    answerArray: [`يمكنك التواصل معانا من خلال -- 05000000`],
    type: 'text',
    reply: {
      text: '',
      reply: false,
