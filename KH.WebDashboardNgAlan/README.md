...
## Features
+ Integrated with knight architecture authentication and permissions handling 
+ Added support for Arabic language 
+ OpenAPi swaager integration to gel all services and model from backend server
+ `ng-zorro-antd` based
+ Responsive Layout
+ I18n
